import { StyleSheet, Text, View, TouchableOpacity, ImageBackground, GestureResponderEvent, ImageSourcePropType, Dimensions, Pressable } from 'react-native';
...
const Dungeon: React.FC = ({ }) => {
    ...
    const markerPress = (event: GestureResponderEvent) => {
        setMarker_coords({
                        ...
                        <>
                            ...
                            <View style={{
                                ...
                                {dungeonList.map((d: string) => {
                                    return (
                                        <TouchableOpacity key={d} style={styles.dungeon_button}
                                            onPress={() => dispatchDungeon(d)}>
                                ...
                                <View style={styles.image_container}>
                                    ...
                                    >
                                        <Pressable key="lastroom"
                                            onPress={() => setPromptComplete(true)}
