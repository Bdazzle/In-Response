...
import { Text, Image, View, StyleSheet, TouchableOpacity, TouchableWithoutFeedback, Dimensions, TextInput, TextInputChangeEventData, NativeSyntheticEvent, KeyboardAvoidingView, Platform, Pressable } from 'react-native';
        ...
        <View style={{
            ...
            <KeyboardAvoidingView
                ...
                style={[styles.container, {
                    height: route.params.counterType === 'storm' ? height / 2 : height,
                    width: width,
                }]}>
                ...
                {total !== undefined &&
                    <View style={styles.button_wrapper}>
                        ...
                        <TouchableOpacity style={styles.total_wrapper}>
            ...
            { route.params.counterType === 'storm' && 
                <View testID='mana_container' style={{
                    height: height / 2,
                    flex: 1,
                    top: 0,
                    overflow: 'visible'
