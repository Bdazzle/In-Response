...
import {Text, GestureResponderEvent, View, TouchableOpacity, StyleSheet } from "react-native";
    ...
    return (
        <View style={[styles.modal_container, {
            ...
            <View style={styles.button_container}>
                <TouchableOpacity style={styles.complete_modal_buttons} onPress={(e) => handleComplete(e)}>
                ...
                <TouchableOpacity style={styles.complete_modal_buttons} onPress={(e) => handleCancel(e)}>
