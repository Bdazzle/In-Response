            ...
            style={[scaleStyles,
                {
                    ...
                    maxHeight: Object.keys(globalPlayerData).length === 2 ? `25%` : `33%`,// 100/maximum # of potential players - 1
                    margin: '2%',
                        ...
                        <View style={styles.damage_row}>
                            {
                                ...
                                >
                                    <Svg viewBox='-50 0 600 600'
                                        style={{
                                            width: componentDimensions?.width ? componentDimensions.width / 4 : 20,
                            ...
                            }
                            {
                                globalPlayerData[playerID!] && <Text style={[styles.all_text, {
                                    color: globalPlayerData[oppponentID].colors.secondary,
                                    fontSize: componentDimensions && componentDimensions?.height * .6,
                                    width: componentDimensions?.width ? componentDimensions.width / 2 : 20,
                                }]}
